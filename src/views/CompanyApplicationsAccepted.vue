      ...
      <div class="company-header">
        <div class="header-left">
          ...
          <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item :to="{ path: '/company/applications' }">申请管理</el-breadcrumb-item>
            <el-breadcrumb-item>已通过申请</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
      </div>

      <div class="accepted-container">
        <CompanyApplicationsList :status-filter="'accepted'" />
      </div>
    </div>
  </div>
</template>
