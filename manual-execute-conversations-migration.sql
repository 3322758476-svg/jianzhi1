-- 手动执行conversations表迁移脚本
-- 这个脚本会创建conversations表和相关索引、策略

SELECT '开始执行对话表迁移...' as status;
...
SELECT '✅ conversations表创建完成' as status;
